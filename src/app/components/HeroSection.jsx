    ...
    return (
        <section className="py-12 lg:py-16">
            <div className="grid grid-cols-1 sm:grid-cols-12">
                ...
                >
                    <h1 className="text-[var(--text-primary)] mb-4 text-4xl sm:text-5xl lg:text-8xl leading-normal font-extrabold">
                    ...
                    <div>
                        ...
                        <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-800 hover:scale-105 text-white mt-3 cursor-pointer">
                            <span className="block bg-[var(--background)] hover:bg-[var(--card-bg)] rounded-full px-5 py-2 transition-colors duration-200 text-[var(--text-primary)]">
                                Download CV
                            </span>
                        </button>
                    </div>
                ...
                <motion.div 
                    ...
                    <div className="rounded-full bg-[var(--card-bg)] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative shadow-[0_0_20px_rgba(0,0,0,0.5)]">
                        <Image
